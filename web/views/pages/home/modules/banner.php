<div class="container-fluid banner" style="position:relative; background: url('<?php echo $path ?>views/assets/img/banner/1/banner.jpg');background-size:cover;background-position: center; background-repeat: no-repeat;">
